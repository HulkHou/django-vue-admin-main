...
class ReportOutputvalue(CoreModel):
    section_name = models.CharField(max_length=255, verbose_name="分部名称", help_text="分部名称")
    year = models.CharField(max_length=255, verbose_name="年度", help_text="年度")
    month = models.CharField(max_length=255, verbose_name="月度", help_text="月度")
...
class ReportTotalProgress(CoreModel):
    section_name = models.CharField(max_length=255, verbose_name="分部名称", help_text="分部名称")
    date = models.CharField(max_length=255, verbose_name="日期", help_text="日期")
    total_progress = models.FloatField(max_length=64, verbose_name="工期进度线", help_text="工期进度线")
    month_progress_target = models.FloatField(max_length=64, verbose_name="月度计划", help_text="月度计划")
    month_progress_actual = models.FloatField(max_length=64, verbose_name="月度完成", help_text="月度完成")

    class Meta:
        db_table = table_prefix + "report_total_progress"
        verbose_name = "工期进度报表"
        verbose_name_plural = verbose_name
        ordering = ['id']


class ReportAccessibleLand(CoreModel):
    land_section = models.CharField(max_length=255, verbose_name="土地标段", help_text="土地标段")
    land_code = models.IntegerField(default=0, verbose_name="土地编号", help_text="土地编号", blank=True)
    status = models.IntegerField(default=0, verbose_name="土地状态", help_text="土地状态", blank=True)

    class Meta:
        db_table = table_prefix + "report_accessible_land"
        verbose_name = "土地进场示意图"
        verbose_name_plural = verbose_name
        ordering = ['id']


class ReportChangeProgress(CoreModel):
    land_section = models.CharField(max_length=255, verbose_name="土地标段", help_text="土地标段")
    year = models.CharField(max_length=255, verbose_name="年度", help_text="年度")
    month = models.CharField(max_length=255, verbose_name="月度", help_text="月度")
    change_progress_target = models.FloatField(max_length=64, verbose_name="迁改计划值", help_text="迁改计划值")
    change_progress_actual = models.FloatField(max_length=64, verbose_name="迁改实际值", help_text="迁改实际值")
    change_progress_predict = models.FloatField(max_length=64, verbose_name="迁改预计值", help_text="迁改预计值")

    class Meta:
        db_table = table_prefix + "report_change_progress"
        verbose_name = "迁改进度报表"
        verbose_name_plural = verbose_name
        ordering = ['id']
