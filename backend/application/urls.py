...
urlpatterns = (
        [
            ...
            path("end/api/system/", include("dvadmin.system.urls")),
            path("end/api/report/", include("dvadmin.report.urls")),
            path("end/api/login/", LoginView.as_view(), name="token_obtain_pair"),
            path("end/api/logout/", LogoutView.as_view(), name="token_obtain_pair"),
            path("end/token/refresh/", TokenRefreshView.as_view(), name="token_refresh"),
            re_path(
